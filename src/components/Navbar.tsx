...
export function Navbar() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 md:bottom-auto md:top-8 bg-white/80 backdrop-blur-lg rounded-full px-5 py-2.5 border border-brand-border shadow-[0_8px_30px_rgba(0,0,0,0.05)]">
